...
# Adjust the labels for publication
ht@ht_list$matrix_8@top_annotation@anno_list$PTEN_Status@label <- "PTEN"
ht@ht_list$matrix_8@top_annotation@anno_list$PTEN_Status@name <- "PTEN"
ht@ht_list$matrix_8@top_annotation@anno_list$Infusions@label <- "No. Infusions"
ht@ht_list$matrix_8@top_annotation@anno_list$Infusions@name <- "No. Infusions"
ht@ht_list$matrix_8@top_annotation@anno_list$Tissue_pIGF1R@label <- "Tissue pIGF1R"
ht@ht_list$matrix_8@top_annotation@anno_list$Tissue_pIGF1R@name <- "Tissue pIGF1R"
ht@ht_list$matrix_8@top_annotation@anno_list$Tumour_pS6@label <- "Tumour pS6"
ht@ht_list$matrix_8@top_annotation@anno_list$Tumour_pS6@name <- "Tumour pS6"
ht@ht_list$matrix_8@top_annotation@anno_list$Serum_IGF1@label <- "Bioactive IGF1"
ht@ht_list$matrix_8@top_annotation@anno_list$Serum_IGF1@name <- "Bioactive IGF1"
